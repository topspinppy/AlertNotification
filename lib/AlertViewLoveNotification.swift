...
open class AlertViewLoveNotification: UIView {
    ...
    fileprivate func interceptOrientationChange(){
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(AlertViewLoveNotification.onOrientationChange), name: NSNotification.Name.UIDevice.orientationDidChangeNotification, object: nil)
    }
